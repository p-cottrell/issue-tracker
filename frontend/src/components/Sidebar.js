...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 lg:flex lg:flex-col lg:h-initial lg:shadow-lg flex-shrink-0`}>
